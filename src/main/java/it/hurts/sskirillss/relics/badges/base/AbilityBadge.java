...
public abstract non-sealed class AbilityBadge extends AbstractBadge {
    ...
    public final ResourceLocation getIconTexture(LivingEntity entity, ItemStack stack) {
        return ResourceLocation.fromNamespaceAndPath(Relics.MODID, "textures/gui/description/general/badges/ability/" + getId() + ".png");
    }

    @Override
    public final ResourceLocation getOutlineTexture(LivingEntity entity, ItemStack stack) {
        return ResourceLocation.fromNamespaceAndPath(Relics.MODID, "textures/gui/description/general/badges/ability/" + getId() + "_outline.png");
    }
}