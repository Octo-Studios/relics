...
public class CutGlassBootModel extends HumanoidModel<LivingEntity> {
    public static final ModelLayerLocation LAYER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Relics.MODID, "cut_glass_boot"), "cut_glass_boot");

    public ModelPart feetPart;

    public CutGlassBootModel(ModelPart root) {
        super(root);
