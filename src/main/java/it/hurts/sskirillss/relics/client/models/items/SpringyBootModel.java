...
public class SpringyBootModel extends HumanoidModel<LivingEntity> {
    ...
    public static LayerDefinition constructLayerDefinition() {
        ...
        PartDefinition feetPart = partDefinition.addOrReplaceChild("feetPart", CubeListBuilder.create().texOffs(20, 5).addBox(-2.5F, 9.5F, -4.0F, 5.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
                .texOffs(0, 12).addBox(-2.5F, 6.5F, -2.5F, 5.0F, 6.0F, 5.0F, new CubeDeformation(0.0F))
                .texOffs(0, 1).addBox(-2.5F, 6.5F, -2.5F, 5.0F, 6.0F, 5.0F, new CubeDeformation(-0.25F))
                .texOffs(20, 0).addBox(-2.5F, 9.5F, -4.0F, 5.0F, 3.0F, 2.0F, new CubeDeformation(-0.25F)), PartPose.offset(-2.0F, 11.5F, 0.0F));
