...
public class StarWidget extends AbstractDescriptionWidget implements ITickingWidget {
    ...
    public boolean isLocked() {
        return screen.stack.getItem() instanceof IRelicItem relic && relic.getRelicData(minecraft.player, screen.stack).getAbilitiesData().getAbilityData(screen.ability).getResearchData().isResearched();
    }
