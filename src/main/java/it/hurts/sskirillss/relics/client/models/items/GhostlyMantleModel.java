...
public class GhostlyMantleModel extends HumanoidModel<LivingEntity> {
    public static final ModelLayerLocation LAYER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Relics.MODID, "ghostly_mantle"), "ghostly_mantle");

    public ModelPart bodyPart;
    public ModelPart leftArmPart;
    public ModelPart rightArmPart;

    public GhostlyMantleModel(ModelPart root) {
        super(root);
