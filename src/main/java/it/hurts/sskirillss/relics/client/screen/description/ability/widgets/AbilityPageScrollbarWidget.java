...
public class AbilityPageScrollbarWidget extends AbstractDescriptionWidget implements ITickingWidget {
    ...
    public AbilityPageScrollbarWidget(int x, int y, AbilityDescriptionScreen screen) {
