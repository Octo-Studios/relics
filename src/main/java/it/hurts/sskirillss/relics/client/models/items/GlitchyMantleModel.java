...
public class GlitchyMantleModel extends HumanoidModel<LivingEntity> {
    public static final ModelLayerLocation LAYER = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(Relics.MODID, "glitchy_mantle"), "glitchy_mantle");

    public ModelPart bodyPart;
    public ModelPart leftArmPart;
    public ModelPart rightArmPart;

    public GlitchyMantleModel(ModelPart root) {
        super(root);
