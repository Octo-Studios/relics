...
public class RelicsBadges {
    public static final DeferredRegister<AbstractBadge> BADGES = DeferredRegister.create(RelicsRegistries.BADGE_REGISTRY, Relics.MODID);
