...
public class FlawlessUtils {
    ...
    public static int getColor(LivingEntity entity, ItemStack stack, int color) {
        return getColor(stack.getItem() instanceof IRelicItem relic && relic.getRelicData(entity, stack).isVisuallyFlawless(), color);
    }
    ...
    public static ResourceLocation getTexture(LivingEntity entity, ItemStack stack, ResourceLocation location) {
        return getTexture(stack.getItem() instanceof IRelicItem relic && relic.getRelicData(entity, stack).isVisuallyFlawless(), location);
    }
}
